...
def tumayo_ka():#use toplevel for subwindows
    ...
    tumayo_window.title("Tumayo ka, Tangina Ka1!")
    tumayo_window.geometry("300x200")
    tumayo_window.attributes("-topmost", True)
    my_label = tk.Label(tumayo_window, text="Tumayo Ka, Tangina Ka 1!!", font=("Helvetica", 14))
...
def umupo_ka():#use toplevel for subwindows
    ...
    umupo_window.title("Umupo kana, Bwesit ka 1!")
    umupo_window.geometry("300x200")
    umupo_window.attributes("-topmost", True)
    my_label = tk.Label(umupo_window, text="Umupo kana, Bwesit ka 1!!", font=("Helvetica", 14))
    # Centered using place (x and y relative to 0-1)
    my_label.place(relx=0.5, rely=0.5, anchor="center")
